...
func init() {
	...
	flag.StringVar(&Args.PackagesSeparated, "packages", "base-cygwin,cygwin,base-files,bash,patch,tar,xz,gzip,bzip2,hostname,curl,which,unzip,grep,gawk,vim,mingw64-i686-gcc-core,mingw64-i686-binutils,diffutils,diffstat", "packages to install (comma separated)")
